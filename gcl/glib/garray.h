...
#include <vapl/vapl_arrays.h>

/* GArray */
#undef  GArray
#define GArray                          VaplArray
#undef  g_array_new
...
#undef  g_array_ref
#define g_array_ref(a)                  vapl_array_ref((a))
#undef  g_array_unref
#define g_array_unref(a)                vapl_array_unref((a))
#undef  g_array_append_val
#define g_array_append_val(a, v)        vapl_array_append((a), &(v))
    ...
    uint32_t num_elements)
{
    ...
    return vapl_array_new(element_size, num_elements);
}
